...
Running the Program:
	...
	To run the program, first locate the application (.EXE) file under the “OvenProjectZ” folder. Double-click it to launch the application. Most modern programs create a desktop shortcut to this file automatically, but this program does not have an installation process, so shortcuts must be added manually.
